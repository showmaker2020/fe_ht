...
import { deleteRoom ,getAllRooms } from '../utils/ApiFunciton';
...
const ExistingRooms = () => {
    ...
    const handleDelete = async (roomId) => {
        try {
            ...
            if(result === ""){
                ...
                console.error(`Error deletting room: ${result.message}`);
            }
    ...
    const indexOfFirtstRoom = indexOfLastRoom - roomsPerPage;
    const currentRooms = filteredRooms.slice(indexOfFirtstRoom, indexOfLastRoom);
  return (
    <>
      {isLoading ? (
                        ...
                        {currentRooms.map((room) => (
                            <tr key = {room.id} className = "text-center">
                                ...
                                <td className = "gap-2 d-flex justify-content-center">
                                    ...
                                    <Link to = {`/edit-room/${room.id}`} className = "d-flex justify-content-center gap-2">
